...
alter type "public"."credit_transaction_type" rename to "credit_transaction_type__old_version_to_be_dropped";
create type "public"."credit_transaction_type" as enum ('purchase', 'usage', 'freemium', 'topup');
alter table "public"."credit_transactions" alter column type type "public"."credit_transaction_type" using type::text::"public"."credit_transaction_type";
drop type "public"."credit_transaction_type__old_version_to_be_dropped";
