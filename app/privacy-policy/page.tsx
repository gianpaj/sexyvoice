  ...
  return (
    ...
    >
      <div className="mx-auto max-w-2xl px-4 py-8">
        ...
        <p>
          SexyVoice.ai (“we,” “our,” or “us”) is committed to protecting your
          privacy. This Privacy Policy explains how your personal information is
          collected, used, and disclosed by SexyVoice.ai.
        </p>
        <p>
          ...
          SexyVoice.ai. By accessing or using our Service, you signify that you
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              ...
              SexyVoice.ai and use the services.
            </li>
            <li>
            ...
            <li>
              ...
              SexyVoice.ai or are under contract to perform a service on behalf
            ...
            <li>
              Service: refers to the service provided by SexyVoice.ai as
            ...
            <li>
              You: a person or entity that is registered with SexyVoice.ai to
              use the Services.
            </li>
          </ul>
        </p>
        ...
        <h2>
          When does SexyVoice.ai use end user information from third parties?
        </h2>
        <p>
          SexyVoice.ai will collect End User Data necessary to provide the
          SexyVoice.ai services to our customers.
        </p>
        <p>
        ...
        <h2>
          When does SexyVoice.ai use customer information from third parties?
        </h2>
        <p>
          ...
          interest in becoming a SexyVoice.ai customer, we receive information
          from a third party that provides automated fraud detection services to
          SexyVoice.ai. We also occasionally collect information that is made
        ...
        <p>
          SexyVoice.ai will collect personal information that you submit to us.
        ...
        <p>
          ...
          SexyVoice.ai to you and fulfill the purposes described in this policy.
        ...
        <p>
          ...
          absolute security of any information you transmit to SexyVoice.ai or
        ...
        <p>
          SexyVoice.ai is incorporated in Spain. Information collected via our
        ...
        <h2>
          Is the information collected through the SexyVoice.ai Service secure?
        </h2>
        <p>
        ...
        <p>
          ...
          information SexyVoice.ai collects depend on your relationship with
          SexyVoice.ai. Personnel may update or correct their information as
        ...
        <p>
          ...
          of the assets of SexyVoice.ai or any of its Corporate Affiliates (as
          defined herein), or that portion of SexyVoice.ai or any of its
        ...
        <p>
          ...
          SexyVoice.ai, whether by ownership or otherwise. Any information
        ...
        <p>
          The laws of Spain, excluding its conflicts of law rules, shall govern
        ...
        <p>
          By using SexyVoice.ai or contacting us directly, you signify your
        ...
        <p>
          ...
          right thing to do. At SexyVoice.ai we strongly believe that your data
        ...
        <p>
          ...
          requirements of GDPR. SexyVoice.ai processes or stores all personal
