  ...
  return (
    ...
    >
      <div className="container mx-auto my-8 px-4">
        ...
        <h2>General Terms</h2>
        <p>
          By accessing and placing an order with SexyVoice.ai, you confirm that
          ...
          you and SexyVoice.ai.
        </p>
        <p>
          Under no circumstances shall SexyVoice.ai team be liable for any
          ...
          SexyVoice.ai team or an authorized representative has been advised of
        ...
        <p>
          SexyVoice.ai will not be responsible for any outcome that may occur
        ...
        <h2>License</h2>
        <p>
          SexyVoice.ai grants you a revocable, non-exclusive, non-transferable,
          limited license to download, install and use the website strictly in
          accordance with the terms of this Agreement.
        </p>
        <p>
          These Terms & Conditions are a contract between you and SexyVoice.ai
          (referred to in these Terms & Conditions as "SexyVoice.ai", "us", "we"
          or "our"), the provider of the SexyVoice.ai website and the services
          accessible from the SexyVoice.ai website (which are collectively
          referred to in these Terms & Conditions as the "SexyVoice.ai
          Service").
        </p>
        <p>
          ...
          SexyVoice.ai Service. In these Terms & Conditions, "you" refers both
        ...
        <ul>
          ...
          <li>
            ...
            it refers to SexyVoice.ai, that is responsible for your information
            under this Terms & Conditions.
          </li>
          <li>
            Country: where SexyVoice.ai or the owners/founders of SexyVoice.ai
            are based, in this case is{' '}
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit SexyVoice.ai
            and use the services.
          </li>
          <li>
            Service: refers to the service provided by SexyVoice.ai as described
          ...
          <li>
            Website: SexyVoice.ai's site, which can be accessed via this URL:
            https://sexyvoice.ai
          </li>
          <li>
            You: a person or entity that is registered with SexyVoice.ai to use
            the Services.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            notice of copyright or trademark) of SexyVoice.ai or its affiliates,
            partners, suppliers or the licensors of the website.
          </li>
        </ul>
        <h2>Return and Refund Policy</h2>
        <p>
          Thanks for shopping at SexyVoice.ai. We appreciate the fact that you
        ...
        <p>
          ...
          apply to transactions at SexyVoice.ai. We’ll be as brief as our
          attorneys will allow. The main thing to remember is that by placing an
          order or making a purchase at SexyVoice.ai, you agree to the terms
          along with SexyVoice.ai's Privacy Policy.
        </p>
        <p>
        ...
        <p>
          ...
          (collectively, "Suggestions") provided by you to SexyVoice.ai with
          respect to the website shall remain the sole and exclusive property of
          SexyVoice.ai.
        </p>
        <p>
          SexyVoice.ai shall be free to use, copy, modify, publish, or
        ...
        <p>
          ...
          SexyVoice.ai. We are not responsible for the content, accuracy or
        ...
        <h2>Cookies</h2>
        <p>
          SexyVoice.ai uses "Cookies" to identify the areas of our website that
        ...
        <p>
          You acknowledge and agree that SexyVoice.ai may stop (permanently or
          ...
          do not need to specifically inform SexyVoice.ai when you stop using
          the Service. You acknowledge and agree that if SexyVoice.ai disables
        ...
        <p>
          SexyVoice.ai reserves the right to modify, suspend or discontinue,
        ...
        <p>
          SexyVoice.ai may from time to time provide enhancements or
        ...
        <p>
          ...
          of the website. You agree that SexyVoice.ai has no obligation to (i)
        ...
        <p>
          You acknowledge and agree that SexyVoice.ai shall not be responsible
          ...
          or any other aspect thereof. SexyVoice.ai does not assume and shall
        ...
        <p>
          SexyVoice.ai may, in its sole discretion, at any time and for any or
        ...
        <p>
          ...
          SexyVoice.ai, in the event that you fail to comply with any provision
        ...
        <p>
          Termination of this Agreement will not limit any of SexyVoice.ai's
        ...
        <p>
          You agree to indemnify and hold SexyVoice.ai and its parents,
        ...
        <p>
          ...
          permitted under applicable law, SexyVoice.ai, on its own behalf and on
          ...
          trade practice. Without limitation to the foregoing, SexyVoice.ai
        ...
        <p>
          Without limiting the foregoing, neither SexyVoice.ai nor any
          SexyVoice.ai's provider makes any representation or warranty of any
          ...
          of SexyVoice.ai are free of viruses, scripts, trojan horses, worms,
        ...
        <p>
          ...
          of SexyVoice.ai and any of its suppliers under any provision of this
        ...
        <p>
          ...
          SexyVoice.ai or its suppliers be liable for any special, incidental,
          ...
          provision of this Agreement), even if SexyVoice.ai or any supplier has
        ...
        <p>
          ...
          notices published by SexyVoice.ai on the Services, shall constitute
          the entire agreement between you and SexyVoice.ai concerning the
          ...
          waiver of such term or any other term, and SexyVoice.ai's failure to
          assert any right or provision under this Agreement shall not
          constitute a waiver of such right or provision. YOU AND SexyVoice.ai
        ...
        <p>
          SexyVoice.ai reserves the right, at its sole discretion, to modify or
        ...
        <p>
          ...
          SexyVoice.ai regarding your use of the website and supersedes all
        ...
        <p>
          ...
          you use or purchase other SexyVoice.ai's services, which SexyVoice.ai
        ...
        <p>
          ...
          arrangement thereof), are owned by SexyVoice.ai, its licensors or
          ...
          SexyVoice.ai, unless and except as is expressly provided in these
        ...
        <p>
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR SexyVoice.ai's
          INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
          action, or other controversy between you and SexyVoice.ai concerning
        ...
        <p>
          In the event of a dispute, you or SexyVoice.ai must give the other a
        ...
        <p>
          If you and SexyVoice.ai don’t resolve any dispute by informal
        ...
        <p>
          ...
          and will become the sole property of SexyVoice.ai without any
          compensation or credit to you whatsoever. SexyVoice.ai and its
        ...
        <h2>Promotions</h2>
        <p>
          SexyVoice.ai may, from time to time, include contests, promotions,
        ...
        <p>
          ...
          representative of SexyVoice.ai. SexyVoice.ai will be entitled to
          ...
          breach by you. SexyVoice.ai operates and controls the SexyVoice.ai
          ...
          SexyVoice.ai Service from other locations do so on their own
          ...
          Conditions (which include and incorporate the SexyVoice.ai Privacy
          Policy) contains the entire understanding, and supersedes all prior
          understandings, between you and SexyVoice.ai concerning its subject
        ...
        <h2>Disclaimer</h2>
        <p>
          SexyVoice.ai is not responsible for any content, code or any other
          imprecision.
        </p>
        <p>SexyVoice.ai does not provide warranties or guarantees.</p>
        <p>
          In no event shall SexyVoice.ai be liable for any special, direct,
        ...
        <p>
          The SexyVoice.ai Service and its contents are provided "as is" and "as
          available" without any warranty or representations of any kind,
          whether express or implied. SexyVoice.ai is a distributor and not a
          publisher of the content supplied by third parties; as such,
          SexyVoice.ai exercises no editorial control over such content and
          ...
          through or accessible via the SexyVoice.ai Service. Without limiting
          the foregoing, SexyVoice.ai specifically disclaims all warranties and
          representations in any content transmitted on or in connection with
          the SexyVoice.ai Service or on sites that may appear as links on the
          SexyVoice.ai Service, or in the products provided as a part of, or
          otherwise in connection with, the SexyVoice.ai Service, including
          without limitation any warranties of merchantability, fitness for a
          particular purpose or non-infringement of third party rights. No oral
          advice or written information given by SexyVoice.ai or any of its
          ...
          change without notice. Without limiting the foregoing, SexyVoice.ai
          does not warrant that the SexyVoice.ai Service will be uninterrupted,
        ...
        <ul>
          <li>
            Via Email: <a href="mailto:info@sexyvoice.ai">info@sexyvoice.ai</a>
          </li>
          <li>
            Via this Link:{' '}
            <a href="https://sexyvoice.ai/en/dashboard">
