...
beforeEach(() => {
  ...
  // Mock requestAnimationFrame to run the first scheduled frame only.
  // The hook schedules a continuous rAF loop; auto-running every frame would
  // create an endless microtask chain in tests.
  let rafId = 0;
  let shouldAutoFlushFrame = true;
