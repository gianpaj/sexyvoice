...
3. **Pick a scene.** Use the **Scene** dropdown at the top of the configuration panel. Hover the icons to preview.
4. **(Optional) Edit the scene text.** Paid users get a live textarea. Rewrite as much or as little as you want.
5. **Press call.** The AI joins already in character.
...
A: You can browse the scene list on any plan. Selecting and customising a scene requires a paid plan.
...
**Q: Can I use a scene without picking one?**

A: Yes. Leave the dropdown on **No scene** and the call behaves exactly as it did before scenes existed.
