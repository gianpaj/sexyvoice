...
export function useGenerationProgressToast(
  ...
  const showGenerationProgressToast = (
  ...
  const dismissGenerationProgressToast = () => {
  ...
  useEffect(() => {
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: React Compiler memoizes dismissGenerationProgressToast, keeping it referentially stable across renders.
  }, [dismissGenerationProgressToast]);
