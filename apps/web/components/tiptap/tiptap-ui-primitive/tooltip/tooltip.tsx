  ...
  function TooltipContent(
    ...
    const content = (
      <div
        ...
        className={cn(
          'fade-in-0 zoom-in-95 z-50 animate-in overflow-hidden rounded-md bg-gray-900 px-3 py-1.5 text-white text-xs shadow-md dark:bg-gray-100 dark:text-gray-900',
          className,
        )}
      >
