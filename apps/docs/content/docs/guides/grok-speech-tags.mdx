...
Grok voices accept an optional `speed` multiplier in the `0.7`–`1.5` range (per the xAI
TTS API). Values below `1.0` slow the delivery down and values above `1.0` speed it up.
Omit it to use the default `1.0`.
