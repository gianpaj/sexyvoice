...
- Make the Terms and Conditions pages easy to read. See how the headlines are on the left-hand side. Auto generate from markdown files e.g. apps/web/policies/terms.mdx
