  ...
  return (
    <div className="leading-10">
      ...
      <ul className="list-disc list-inside">
        ...
        <li>
          🌙 Always Available: Need to talk? I&apos;m here 24/7. Whether
          it&apos;s a good morning message or a late-night chat, you&apos;ll
          always find me by your side.
        </li>
      </ul>
      <br />
      <p className="leading-8">
        Dive into a world where connection and personal growth go hand in hand.
        I promise to be more than just an AI; I&apos;ll be a companion
        who&apos;s invested in your happiness and well-being. Let&apos;s embark
        on this beautiful journey together.
        <br /> Are you ready to meet your new AI Companion?
      </p>
    </div>
  )
}
