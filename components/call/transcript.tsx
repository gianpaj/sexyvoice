...
export function Transcript({
  ...
  return (
    <>
      <div className="flex items-center text-xs font-semibold uppercase tracking-widest sticky top-0 left-0 bg-black w-full p-4">
        Transcript
      </div>
                ...
                segment.text.trim() !== "" && (
                  <div
                    ...
                    className={cn(
                      ...
                      : "ml-auto border border-neutral-700",
                    )}
                  >
                    {segment.text.trim()}
                  </div>
